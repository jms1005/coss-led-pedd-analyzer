...
def sheet1(phase):
  ...
  # 단계마다 핀 배정의 출처 파일이 다르다.
  # Phase 2 는 발광·검출만 쓰므로 pedd.c 하나이고, Phase 4 는 버튼과
  # OLED 가 더해져 button.c · i2c.c 까지 근거가 된다.
  SRC = {
    2: "핀 배정 출처: firmware/common/pedd.c",
    4: "핀 배정 출처: firmware/common/pedd.c · button.c · i2c.c",
  }
  sh.foot(SRC[phase])
  return sh
